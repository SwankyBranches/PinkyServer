...
Config.Shops = {
    ...
    YouTool = {
        ...
        Items = {
            { name = 'tuning_laptop' , price = 25000},
    ...
    WeaponShop = {
        ...
        Items = {
            { name = "WEAPON_PISTOL", price = 349 },
			{ name = "disc_ammo_pistol", price = 15 },
			{ name = "WEAPON_HEAVYPISTOL", price = 649 },
			{ name = "WEAPON_PUMPSHOTGUN", price = 475 },
			{ name = "disc_ammo_shotgun", price = 20 },
			{ name = "WEAPON_KNIFE", price = 50 },
			{ name = "WEAPON_KNUCKLE", price = 35 },
			{ name = "WEAPON_MACHETE", price = 55 },
			{ name = "WEAPON_SWITCHBLADE", price = 45}
        }
    },
