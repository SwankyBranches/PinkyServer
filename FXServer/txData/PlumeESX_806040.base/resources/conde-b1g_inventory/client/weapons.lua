...
AddEventHandler('conde-inventoryhud:useWeapon', function(weapon)
    ...
    TriggerEvent('conde-inventoryhud:notification', weapon,"Retrieve", 1, false)
...
RegisterCommand("unequip", function(source, args, rawCommand)
    if currentWeapon ~= nil then
        ...
        exports['b1g_notify']:Notify('error', 'You dont have a gun in your hand.')
    end
end)
...
function RemoveWeapon(weapon)
    ...
    canFire = true
    TriggerEvent('conde-inventoryhud:notification', weapon,"Put away", 1, false)
end
